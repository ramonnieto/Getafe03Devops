...
#modificada la versión --- actualización del script
TOMCAT_VERSION="9.0.100"


## First install wget
## Primeiro instale o wget
#usamos cloudflare que nos gusta más
...
# Pasamos de java de oracle y usamos openjdk -- la misma verison que en el host que usa Jenkins (IMPORTANTE LAS VERSIONES)
...
# los comentarios anteriores son por modificaciones de Environment en versiones superiores de Tomcat. 
...
<tomcat-users>
<!--
    Comments comentarios sobre la administración: modificacmos el usuario para automatizar todo conel usuario vagrant
-->
   <role rolename="admin-gui"/>
   <role rolename="manager-gui"/>
   <role rolename="manager-script"/>
   <user username="vagrant" password="vagrant" roles="admin-gui,manager-gui,manager-script"/>
